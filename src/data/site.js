...
export const products = [
  ...
  },
  {
    id: 39,
    code: 'BOD-TUP-01',
    name: 'Invitación Boda — Julieta & Mateo',
    category: 'boda',
    plan: 'Premium',
    price: 88540,
    color: 'verde',
    gradient: 'from-[#3F4A34] to-[#F3EEE9]',
    badge: 'Nuevo',
    demoUrl: 'https://cherished-dessert-477573.framer.app',
    image: '/demos/boda/julieta-mateo/foto-hero.jpg',
    style: 'Estancia de campo — video de portada, cómo nos conocimos, cronograma del día y RSVP',
    palette: ['#F3EEE9', '#3F4A34', '#6E7A5C'],
  },
]